...
class CreateSurveyorInvestigationReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('surveyor_investigation_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('surveyor_investigation_reports');
    }
}
