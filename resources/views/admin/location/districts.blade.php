                ...
                <div class="card">
                            ...
                            <form action="" method="get">
                                ...
                                <div class="d-flex align-items-center position-relative mr-2">
                                    <input type="search" class="form-control form-control-solid w-250px "
                                           name="search_string" id="search_string" placeholder="জেলার নাম অনুসন্ধান করুন"
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            @forelse(@$districts as $district)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ $district->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$district->division->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <!--begin::Edit-->
                                            <a href="#" data-item="{{ $district }}" data-updateurl="{{ route('location.district.update', $district->id) }}"
                                            ...
                                            <!--end::Edit-->
                                            <!--begin::Delete-->
                                            <button class="btn btn-icon btn-danger deleteItem" data-formid="delete_row_form_{{$district->id}}">
                                            ...
                                            <form action="{{ route('location.district.delete', $district->id) }}" method="post" id="delete_row_form_{{ $district->id }}">
                                                {{ method_field('DELETE') }}
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="text-center">কোন রেকর্ড পাওয়া যায়নি</td>
                                </tr>
                            @endforelse
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <!--begin:Form-->
                            <form id="kt_modal_new_target_form" class="form" action="{{ route('location.district.store') }}" method="post">
                                @csrf
                                <!--begin::Heading-->
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">জেলা যুক্ত করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Input group-->
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select a Division" name="division_id" required>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <label class="d-flex align-items-center fs-6 fw-bolder mb-2">
                                        <span class="required">জেলা নাম</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="জেলা নাম"></i>
                                    </label>
                                    <!--end::Label-->
                                    <input type="text" class="form-control form-control-solid" placeholder="জেলা নাম" name="name" />
                                </div>
                                <!--end::Input group-->
                                <!--begin::Actions-->
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_new_target_edit_form" class="form" action="" method="post">
                                ...
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">জেলার নাম আপডেট করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Input group-->
    ...
    <script>
        $(function() {
            ...
            $('.edit').on('click', function(e) {
                ...
                modal.find('select[name=division_id]').val($(this).data('item').division_id)
