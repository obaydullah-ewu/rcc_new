                        ...
                        <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                            ...
                            <a href="#"
                               class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                ...
                                <!--end::Svg Icon-->{{ $admin->executive_role }}</a>
                            @endif
                            @if($admin->address )
                            <a href="#"
                               class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="fs-2 fw-bolder" data-kt-countup="true"
                                         data-kt-countup-value="{{ @$total_event_registered_user }}" data-kt-countup-prefix="">0
                                    </div>
                                </div>
                                <!--end::Number-->
                                <!--begin::Label-->
                                <div class="fw-bold fs-6 text-gray-400">Total Registered User on Event</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
