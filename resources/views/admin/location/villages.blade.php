                            ...
                            <form action="" method="get">
                                ...
                                <div class="d-flex align-items-center position-relative mr-2">
                                    <input type="search" class="form-control form-control-solid w-250px "
                                           name="search_string" id="search_string" placeholder="মহল্লা নাম অনুসন্ধান করুন"
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px text-center">বিভাগ নাম</th>
                            ...
                            @forelse($villages as $village)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$village->postOffice->upazila->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$village->postOffice->upazila->district->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$village->postOffice->upazila->district->division->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <!--begin::Edit-->
                                            <a href="#" data-item="{{ $village }}"
                                               data-updateurl="{{ route('location.village.update', $village->id) }}"
                                            ...
                                            <!--end::Edit-->
                                            <!--begin::Delete-->
                                            <button class="btn btn-icon btn-danger deleteItem" data-formid="delete_row_form_{{$village->id}}">
                                            ...
                                            <form action="{{ route('location.village.delete', $village->id) }}" method="post"
                                                  id="delete_row_form_{{ $village->id }}">
                                                {{ method_field('DELETE') }}
                        ...
                        <!--end::Table-->
                        {{ @$villages->links('pagination::bootstrap-4') }}
                    </div>
                    <!--end::Card body-->
                </div>
                <!--end::Card-->
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <!--begin:Form-->
                            <form id="kt_modal_new_target_form" class="form" action="{{ route('location.village.store') }}" method="post">
                                @csrf
                                <!--begin::Heading-->
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">মহল্লা যুক্ত করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <div class="row">
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        ...
                                        <select class="form-select form-select-solid division_id" data-hide-search="true"
                                                data-placeholder="Select a Division" name="division_id" required>
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        ...
                                        <select class="form-select form-select-solid district_id" data-control="select2" data-hide-search="true"
                                                data-placeholder="Select a District" name="district_id" required>
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        ...
                                        <label class="d-flex align-items-center fs-6 fw-bolder mb-2">
                                            ...
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="উপজেলা নাম"></i>
                                        </label>
                                        <!--end::Label-->
                                        <select class="form-select form-select-solid upazila_id" data-control="select2" data-hide-search="true"
                                                data-placeholder="Select a Upazila" name="upazila_id" required>
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        <!--begin::Label-->
                                        <label class="d-flex align-items-center fs-6 fw-bolder mb-2">
                                            <span class="required">পোস্ট অফিস নাম</span>
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="পোস্ট অফিস নাম"></i>
                                        </label>
                                        <!--end::Label-->
                                        <select class="form-select form-select-solid post_office_id" data-control="select2" data-hide-search="true"
                                                data-placeholder="Select a post office" name="post_office_id" required>
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        <!--begin::Label-->
                                        <label class="d-flex align-items-center fs-6 fw-bolder mb-2">
                                            <span class="required">ওয়ার্ড নম্বর</span>
                                        </label>
                                        <!--end::Label-->
                                        <div class="input-group">
                                            ...
                                            <select class="form-select form-select-solid ward_id" name="ward_id" required>
                                                <option value="">-- ওয়ার্ড নম্বর --</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        <!--begin::Label-->
                                        <label class="d-flex align-items-center fs-6 fw-bolder mb-2">
                                            <span class="required">মহল্লা নাম</span>
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="মহল্লা নাম"></i>
                                        </label>
                                        <!--end::Label-->
                                        <input type="text" class="form-control form-control-solid" placeholder="মহল্লা নাম" name="name" required/>
                                    </div>
                                    <!--end::Input group-->
                                </div>
                                <!--begin::Actions-->
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_new_target_edit_form" class="form" action="" method="post">
                                ...
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">মহল্লা আপডেট করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <div class="row">
    ...
    <script>
        $(function () {
            ...
            $('.edit').on('click', function (e) {
                ...
                var post_office_id = $(this).data('item').post_office_id
                var ward_id = $(this).data('item').ward_id
                ...
                $.ajax({
                    ...
                    type: "GET",
                    dataType: 'json',
                    data: {'upazila_id': upazila_id, 'ward_id':ward_id},
                    success: function (response) {
                        $('.ward_id').html('<option value="">-- ওয়ার্ড নম্বর --</option>');
                        $.each(response.wards, function (key, value) {
                            modal.find(".ward_id").append('<option value="' + value.id + '">' + value.name + '</option>');
                        });
                        modal.find('.ward_id').val(response.ward_id)
                    }
                });
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(response.postOffices, function (key, value) {
                            modal.find(".post_office_id").append('<option value="' + value.id + '">' + value.name + '</option>');
                        });
                        modal.find('.post_office_id').val(response.post_office_id)
                    }
                });
            })
        })
