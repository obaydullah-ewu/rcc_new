                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px text-center">নাম</th>
                            ...
                            @forelse($divisions as $division)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$division->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <!--begin::Edit-->
                                            <a href="#" data-item="{{ $division }}" data-updateurl="{{ route('location.division.update', $division->id) }}"
                                            ...
                                            <!--end::Edit-->
                                            <!--begin::Delete-->
                                            <button class="btn btn-icon btn-danger deleteItem" data-formid="delete_row_form_{{$division->id}}">
                                            ...
                                            <form action="{{ route('location.division.delete', $division->id) }}" method="post" id="delete_row_form_{{ $division->id }}">
                                                {{ method_field('DELETE') }}
