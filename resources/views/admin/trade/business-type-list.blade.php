                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px text-left">ব্যবসায়ের ধরণ</th>
                                <th class="min-w-100px text-left">ব্যবসায়ের উপ-ধরণ</th>
                                <th class="min-w-100px text-left">স্ট্যাটাস</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                                            {{ en2bn($loop->iteration + $businessTypes->firstItem() - 1) }}
                                        </div>
                                    </td>
                                    <!--end::Checkbox-->
                                    <td class="text-left">
                                        <span class="text-gray-800"> {{ $businessType->type_name }}</span><br>
                                    </td>
                                    <td class="text-left">
                                        <span class="text-gray-800">{{ $businessType->sub_type_name }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <!--begin::Edit-->
                                            <a href="#" data-item="{{ $businessType }}"
                                               data-updateurl="{{ route('admin.trade.business-type.update', $businessType->id) }}"
                                            ...
                                            <button class="btn btn-icon btn-danger deleteItem"
                                                    data-formid="delete_row_form_{{$businessType->id}}">
                                            ...
                                            <form
                                                action="{{ route('admin.trade.business-management.delete', $businessType->id) }}"
                                                method="post" id="delete_row_form_{{ $businessType->id }}">
                                                {{ method_field('DELETE') }}
                        ...
                        <!--end::Table-->
                        {{ $businessTypes->links('pagination::bootstrap-4') }}
                    </div>
                    <!--end::Card body-->
                </div>
                <!--end::Card-->
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_new_target_form" class="form"
                                  action="{{ route('admin.trade.business-type.store') }}" method="post">
                                @csrf
                                <!--begin::Heading-->
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">ব্যবসা ধরণ যুক্ত করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <div class="row">
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        <div class="form-group">
                                            <label class="required fs-6 fw-bolder mb-2">ব্যবসায়ের ধরণ</label>
                                            <div class="input-group">
                                                <input type="text" name="type_name" placeholder="ব্যবসায়ের ধরণ" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        <div class="form-group">
                                            <label class="required fs-6 fw-bolder mb-2">ব্যবসায়ের উপ-ধরণ</label>
                                            <div class="input-group">
                                                <input type="text" name="sub_type_name" placeholder="ব্যবসায়ের উপ-ধরণ" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_new_target_edit_form" class="form" action="" method="post">
                                ...
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">ব্যবসা ধরণ আপডেট করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <div class="row">
    ...
    <script>
        $(function () {
            ...
            $('.edit').on('click', function (e) {
                ...
                modal.find('input[name=type_name]').val(item.type_name)
                modal.find('input[name=sub_type_name]').val(item.sub_type_name)
