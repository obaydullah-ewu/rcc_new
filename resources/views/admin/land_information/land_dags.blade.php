                            ...
                            <form action="" method="get">
                                ...
                                <div class="d-flex align-items-center position-relative mr-2">
                                    <input type="search" class="form-control form-control-solid w-250px "
                                           name="search_string" id="search_string" placeholder="দাগ নং অনুসন্ধান করুন"
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px text-left">খতিয়ান নাম</th>
                            ...
                            @forelse($landDags as $landDag)
                                ...
                                <tr>
                                    ...
                                    <!--end::Checkbox-->
                                    <td class="text-left"><span class="text-gray-800"> {{ @$landDag->dag_no }}</span></td>
                                    <td class="text-left"><span class="text-gray-800"> {{ @$landDag->landKhotiyan->name }}</span></td>
                                    <td class="text-left"><span class="text-gray-800"> {{ @$landDag->mouza->name }}</span></td>
                                    <td class="text-left">
                                        <span class="text-gray-800">উপজেলা নাম : {{ @$landDag->mouza->upazila->name }}</span><br>
                                        <span class="text-gray-800">জেলা নাম : {{ @$landDag->mouza->upazila->district->name }}</span><br>
                                        <span class="text-gray-800">বিভাগ নাম : {{ @$landDag->mouza->upazila->district->division->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <!--begin::Edit-->
                                            <a href="#" data-item="{{ $landDag }}" data-updateurl="{{ route('admin.land_information.dag.update', $landDag->id) }}"
                                            ...
                                            <!--end::Edit-->
                                            <!--begin::Delete-->
                                            <button class="btn btn-icon btn-danger deleteItem" data-formid="delete_row_form_{{$landDag->id}}">
                                            ...
                                            <form action="{{ route('admin.land_information.dag.delete', $landDag->id) }}" method="post" id="delete_row_form_{{ $landDag->id }}">
                                                {{ method_field('DELETE') }}
                        ...
                        <!--end::Table-->
                        {{ @$landDags->links('pagination::bootstrap-4') }}
                    </div>
                    <!--end::Card body-->
                </div>
                <!--end::Card-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <!--begin:Form-->
                            <form id="kt_modal_new_target_form" class="form" action="{{ route('admin.land_information.dag.store') }}" method="post">
                                @csrf
                                <!--begin::Heading-->
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">দাগ নং যুক্ত করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <div class="row">
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        ...
                                        <label class="d-flex align-items-center fs-6 fw-bolder mb-2">
                                            ...
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="মৌজার নাম"></i>
                                        </label>
                                        <!--end::Label-->
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        ...
                                        <label class="d-flex align-items-center fs-6 fw-bolder mb-2">
                                            ...
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="খতিয়ান নাম"></i>
                                        </label>
                                        <!--end::Label-->
                                        <select class="form-select form-select-solid land_ledger_no_id" name="land_khotiyan_id" required>
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        <!--begin::Label-->
                                        <label class="d-flex align-items-center fs-6 fw-bolder mb-2">
                                            <span class="required">দাগ নং</span>
                                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="দাগ নং"></i>
                                        </label>
                                        <!--end::Label-->
                                        <input type="text" class="form-control form-control-solid" placeholder="দাগ নং" name="dag_no" />
                                    </div>
                                    <!--end::Input group-->
                                </div>
                                <!--begin::Actions-->
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_new_target_edit_form" class="form" action="" method="post">
                                ...
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">দাগ নং আপডেট করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <div class="row">
                                    ...
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        ...
                                        <!--end::Label-->
                                        <input type="text" class="form-control form-control-solid spot_no" placeholder="দাগ নং" name="dag_no" />
                                    </div>
                                    <!--end::Input group-->
                                </div>
                                <!--begin::Actions-->
    ...
    <script>
        $(function() {
            ...
            $('.edit').on('click', function(e) {
                ...
                modal.find('select[name=land_khotiyan_id]').val($(this).data('item').land_khotiyan_id)
                modal.find('input[name=dag_no]').val($(this).data('item').dag_no)
