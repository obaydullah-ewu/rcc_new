                            ...
                            <form action="" method="get">
                                ...
                                <div class="d-flex align-items-center position-relative mr-2">
                                    <input type="search" class="form-control form-control-solid w-250px "
                                           name="search_string" id="search_string" placeholder="ওয়ার্ড নাম অনুসন্ধান করুন"
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px text-center">ওয়ার্ড নাম</th>
                            ...
                            @forelse($wards as $ward)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ 'ওয়ার্ড-'.en2bn($ward->name) }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$ward->upazila->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$ward->district->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$ward->division->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <!--begin::Edit-->
                                            <a href="#" data-item="{{ $ward }}" data-updateurl="{{ route('location.ward.update', $ward->id) }}"
                                            ...
                                            <!--end::Edit-->
                                            <!--begin::Delete-->
                                            <button class="btn btn-icon btn-danger deleteItem" data-formid="delete_row_form_{{$ward->id}}">
                                            ...
                                            <form action="{{ route('location.ward.delete', $ward->id) }}" method="post" id="delete_row_form_{{ $ward->id }}">
                                                {{ method_field('DELETE') }}
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <!--begin:Form-->
                            <form id="kt_modal_new_target_form" class="form" action="{{ route('location.ward.store') }}" method="post">
                                @csrf
                                <!--begin::Heading-->
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">ওয়ার্ড যুক্ত করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <div class="row">
                                    ...
                                    <!--begin::Input group-->
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        <label class="d-flex align-items-center fs-6 fw-bolder mb-2"><span class="required">ওয়ার্ড নাম</span></label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text fw-bolder">ওয়ার্ড-</span>
                                            </div>
                                            <input type="number" min="1" class="form-control form-control-solid" placeholder="" name="name" required />
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                </div>
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_new_target_edit_form" class="form" action="" method="post">
                                ...
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">ওয়ার্ড আপডেট করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <div class="row">
                                    ...
                                    <!--begin::Input group-->
                                    <div class="d-flex flex-column mb-8 fv-row col-md-6">
                                        <label class="d-flex align-items-center fs-6 fw-bolder mb-2"><span class="required">ওয়ার্ড নম্বর</span></label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text fw-bolder">ওয়ার্ড-</span>
                                            </div>
