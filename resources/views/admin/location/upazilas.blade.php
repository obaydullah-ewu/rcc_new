            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card">
                            ...
                            <form action="" method="get">
                                ...
                                <div class="d-flex align-items-center position-relative mr-2">
                                    <input type="search" class="form-control form-control-solid w-250px "
                                           name="search_string" id="search_string" placeholder="উপজেলার নাম অনুসন্ধান করুন"
                    ...
                    <div class="card-body pt-0">
                            ...
                            @forelse(@$upazilas as $upazila)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$upazila->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$upazila->district->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$upazila->district->division->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <!--begin::Edit-->
                                            <a href="#" data-item="{{ $upazila }}" data-updateurl="{{ route('location.upazila.update', $upazila->id) }}"
                                            ...
                                            <!--end::Edit-->
                                            <!--begin::Delete-->
                                            <button class="btn btn-icon btn-danger deleteItem" data-formid="delete_row_form_{{$upazila->id}}">
                                            ...
                                            <form action="{{ route('location.upazila.delete', $upazila->id) }}" method="post" id="delete_row_form_{{ $upazila->id }}">
                                                {{ method_field('DELETE') }}
                        ...
                        <!--end::Table-->
                        {{ @$upazilas->links('pagination::bootstrap-4') }}
                    </div>
                    <!--end::Card body-->
                </div>
                <!--end::Card-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <!--begin:Form-->
                            <form id="kt_modal_new_target_form" class="form" action="{{ route('location.upazila.store') }}" method="post">
                                @csrf
                                <!--begin::Heading-->
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">উপজেলা যুক্ত করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Input group-->
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <select class="form-select form-select-solid district_id" data-hide-search="true" data-placeholder="Select a Team Member" name="district_id" required>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" class="form-control form-control-solid" placeholder="উপজেলা নাম" name="name" required/>
                                </div>
                                <!--end::Input group-->
                                <!--begin::Actions-->
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_new_target_edit_form" class="form" action="" method="post">
                                ...
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">উপজেলার নাম আপডেট করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Input group-->
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    <label class="required fs-6 fw-bolder mb-2">জেলা নাম</label>
                                    <select class="form-select form-select-solid district_id" data-hide-search="true" data-placeholder="Select a district" name="district_id" required>
                                        <option value="">জেলা নাম</option>
                                    </select>
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" class="form-control form-control-solid" placeholder="উপজেলা নাম" name="name" />
                                </div>
                                <!--end::Input group-->
                                <!--begin::Actions-->
                                <div class="text-center">
