                            ...
                            <form action="" method="get">
                                ...
                                <div class="d-flex align-items-center position-relative mr-2">
                                    <input type="search" class="form-control form-control-solid w-250px "
                                           name="search_string" id="search_string" placeholder="গ্রামের নাম অনুসন্ধান করুন"
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px text-center">গ্রাম নাম</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <!--begin::Edit-->
                                            <a href="#" data-item="{{ $village }}" data-updateurl="{{ route('location.village.update', $village->id) }}"
                                            ...
                                            <form action="{{ route('location.village.delete', $village->id) }}" method="post" id="delete_row_form_{{ $village->id }}">
                                                {{ method_field('DELETE') }}
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_new_target_form" class="form" action="{{ route('location.village.store') }}" method="post">
                                ...
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">গ্রাম যুক্ত করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Input group-->
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <select class="form-select form-select-solid division_id" data-hide-search="true" data-placeholder="Select a Division" name="division_id" required>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <select class="form-select form-select-solid district_id" data-control="select2" data-hide-search="true" data-placeholder="Select a District" name="district_id" required>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <select class="form-select form-select-solid upazila_id" data-control="select2" data-hide-search="true" data-placeholder="Select a Upazila" name="upazila_id" required>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <select class="form-select form-select-solid post_office_id" data-control="select2" data-hide-search="true" data-placeholder="Select a post office" name="post_office_id" required>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    <!--begin::Label-->
                                    <label class="d-flex align-items-center fs-6 fw-bolder mb-2">
                                        <span class="required">গ্রাম নাম</span>
                                        <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="গ্রাম নাম"></i>
                                    </label>
                                    <!--end::Label-->
                                    <input type="text" class="form-control form-control-solid" placeholder="গ্রাম নাম" name="name" required />
                                </div>
                                <!--end::Input group-->
                                <!--begin::Actions-->
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_new_target_edit_form" class="form" action="" method="post">
                                ...
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">গ্রাম আপডেট করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Input group-->
