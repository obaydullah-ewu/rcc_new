    ...
    init: function () {
        ...
        !function () {
            ...
            var e = document.getElementById("kt_charts_widget_3_chart"),
                t = (parseInt(KTUtil.css(e, "height")), KTUtil.getCssVariableValue("--bs-gray-500")), a = KTUtil.getCssVariableValue("--bs-gray-200"),
                o = KTUtil.getCssVariableValue("--bs-info"), s = KTUtil.getCssVariableValue("--bs-light-info");
            e && new ApexCharts(e, {
            ...
            var e = document.getElementById("kt_charts_widget_4_chart"),
                t = (parseInt(KTUtil.css(e, "height")), KTUtil.getCssVariableValue("--bs-gray-500")), a = KTUtil.getCssVariableValue("--bs-gray-200"),
                o = KTUtil.getCssVariableValue("--bs-success"), s = KTUtil.getCssVariableValue("--bs-light-success"),
                r = KTUtil.getCssVariableValue("--bs-warning"), i = KTUtil.getCssVariableValue("--bs-light-warning");
            e && new ApexCharts(e, {
            ...
            var e = document.getElementById("kt_charts_widget_5_chart"),
                t = (parseInt(KTUtil.css(e, "height")), KTUtil.getCssVariableValue("--bs-gray-500")), a = KTUtil.getCssVariableValue("--bs-gray-200"),
                o = KTUtil.getCssVariableValue("--bs-primary"), s = KTUtil.getCssVariableValue("--bs-info");
            e && new ApexCharts(e, {
            ...
            var e = document.getElementById("kt_charts_widget_6_chart"),
                t = (parseInt(KTUtil.css(e, "height")), KTUtil.getCssVariableValue("--bs-gray-500")), a = KTUtil.getCssVariableValue("--bs-gray-200"),
                o = KTUtil.getCssVariableValue("--bs-primary"), s = KTUtil.getCssVariableValue("--bs-light-primary"),
            ...
            e && new ApexCharts(e, {
                series: [{name: "Net Profit", data: [30, 30, 50, 50, 35, 35]}, {name: "Revenue", data: [55, 20, 20, 20, 70, 70]}, {
                    name: "Expenses",
            ...
            var e, t, a, o = document.querySelectorAll(".mixed-widget-2-chart"), s = KTUtil.getCssVariableValue("--bs-gray-500"),
            ...
            [].slice.call(e).map((function (e) {
                ...
                if (e) {
                    var a = e.getAttribute("data-kt-chart-color"), o = KTUtil.getCssVariableValue("--bs-" + a),
                        s = KTUtil.getCssVariableValue("--bs-light-" + a), r = KTUtil.getCssVariableValue("--bs-gray-700");
                    new ApexCharts(e, {
                        series: [74],
                        ...
                        plotOptions: {
                            radialBar: {
                                ...
                                dataLabels: {
                                    ...
                                    value: {
                                        color: r, fontSize: "30px", fontWeight: "700", offsetY: 12, show: !0, formatter: function (e) {
                                            return e + "%"
                                        }
                                    }
                                },
            ...
            var e, t, a, o = document.querySelectorAll(".mixed-widget-10-chart"), s = KTUtil.getCssVariableValue("--bs-gray-500"),
                r = KTUtil.getCssVariableValue("--bs-gray-200"), i = KTUtil.getCssVariableValue("--bs-gray-300");
            [].slice.call(o).map((function (o) {
            ...
            var e, t = document.querySelectorAll(".mixed-widget-12-chart"), a = KTUtil.getCssVariableValue("--bs-gray-500"),
            ...
            [].slice.call(t).map((function (t) {
                ...
                new ApexCharts(t, {
                    ...
                    yaxis: {
                        show: !1, axisBorder: {show: !1}, axisTicks: {show: !1, background: a}, labels: {
            ...
            if ("undefined" != typeof FullCalendar && document.querySelector("#kt_calendar_widget_1")) {
                var e = moment().startOf("day"), t = e.format("YYYY-MM"), a = e.clone().subtract(1, "day").format("YYYY-MM-DD"),
                    o = e.format("YYYY-MM-DD"), s = e.clone().add(1, "day").format("YYYY-MM-DD"), r = document.getElementById("kt_calendar_widget_1");
