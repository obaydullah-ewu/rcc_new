                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="{{ route('admin.councilor-signature.update', $signature->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                {{ method_field('PUT') }}
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group mb-4 col-md-4">
                                            ...
                                            <input type="number" min="1" name="ward_no" class="form-control form-control-solid"
                                                   placeholder="ওয়ার্ড নং" value="{{ $signature->ward_no }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{ asset('assets/media/avatars/blank.png') }})">
                                                ...
                                                @if($signature->creator_signature)
                                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ getFile($signature->creator_signature)  }})"></div>
                                                @else
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            ...
                                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{ asset('assets/media/avatars/blank.png') }})">
                                                <!--begin::Preview existing avatar-->
                                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ getFile($signature->councilor_signature)  }})"></div>
                                                <!--end::Preview existing avatar-->
                                                <!--begin::Label-->
                                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
                                                    <i class="bi bi-pencil-fill fs-7"></i>
