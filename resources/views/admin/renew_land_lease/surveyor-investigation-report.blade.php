                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form"
                                  action="{{ route('admin.renew-lease-application.surveyorInvestigationReport.store', $landLease->uuid) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group mb-4 col-md-4">
                                            ...
                                            <input type="date" name="investigation_english_date" class="form-control form-control-solid"
                                                   value="{{ old('investigation_english_date') ?? @$surveyorReport->investigation_english_date }}"
                                                   required>
                                        </div>
                                        <div class="form-group mb-4 col-md-4">
                                            ...
                                            <input type="text" name="investigation_bangla_date" class="form-control form-control-solid"
                                                   value="{{ old('investigation_bangla_date') ?? @$surveyorReport->investigation_bangla_date }}"
                                        ...
                                        <div class="form-group mb-4 col-md-4">
                                            ...
                                            <div class="input-group input-group-solid">
                                                ...
                                                <input type="number" step="any" min="0" name="vat" id="vat" class="form-control form-control-solid"
                                                       placeholder="ভ্যাট" value="{{ old('vat') ?? @$surveyorReport->vat }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group mb-4 col-md-4">
                                            ...
                                            <div class="input-group input-group-solid">
                                                ...
                                                <input type="number" step="any" min="0" name="tax" id="tax" class="form-control form-control-solid"
                                                       placeholder="আয়কর" value="{{ old('tax') ?? @$surveyorReport->tax }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-4 col-md-4">
                                            ...
                                            <div class="input-group input-group-solid">
                                                ...
                                                <input type="number" step="any" min="0" name="stamp_money" class="form-control form-control-solid"
                                                       placeholder="স্ট্যাম্প মূল্য" value="{{ old('stamp_money') ?? @$surveyorReport->stamp_money }}" required>
                                            </div>
                                        </div>
                                        <div class="form-group mb-4 col-md-4">
                                            ...
                                            <div class="input-group input-group-solid">
                                                ...
                                                <input type="number" min="0" name="deposit_money_submit_day" class="form-control form-control-solid"
                                                       placeholder="কত দিন" value="{{ old('deposit_money_submit_day') ?? @$surveyorReport->deposit_money_submit_day }}" required>
                                            </div>
                                        </div>
                                    </div>
