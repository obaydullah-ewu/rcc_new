                                    ...
                                    <div class="row">
                                        <div class="form-group mb-4 col-md-12">
                                            ...
                                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{ asset('assets/media/avatars/blank.png') }})">
                                                ...
                                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ getFile($user->image) ?? asset('assets/media/avatars/blank.png') }})"></div>
                                        ...
                                        <div class="form-group mb-4 col-md-4">
                                            ...
                                            <div class="input-group input-group-solid">
                                                <input type="text" name="password" class="form-control form-control-solid" placeholder="পাসওয়ার্ড" >
                                            </div>
                                        </div>
                                        <div class="form-group mb-4 col-md-4">
