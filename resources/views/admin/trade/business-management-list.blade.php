                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px text-left">অঞ্চল / বাজার শাখা</th>
                                <th class="min-w-100px text-left">ওয়ার্ড নম্বর</th>
                                <th class="min-w-100px text-left">ব্যবসায়ের এলাকা</th>
                                <th class="min-w-100px text-left">মার্কেটের নাম</th>
                            ...
                            @forelse($businessManagements as $businessManagement)
                                <!--begin::Table row-->
                                <tr>
                                    <!--begin::Checkbox-->
                                    <td>
                                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                                            {{ en2bn($loop->iteration + $businessManagements->firstItem() - 1) }}
                                        </div>
                                    </td>
                                    <!--end::Checkbox-->
                                    <td class="text-left">
                                        <span class="text-gray-800"> {{ $businessManagement->market_branch }}</span><br>
                                    </td>
                                    <td class="text-left">
                                        <span class="text-gray-800">{{ "Ward-".$businessManagement->ward_no }}</span>
                                    </td>
                                    <td class="text-left">
                                        <span class="text-gray-800">{{ $businessManagement->location }}</span>
                                    </td>
                                    <td class="text-left">
                                        <span class="text-gray-800">{{ $businessManagement->market_name }}</span>
                                    </td>
                                    <td>
                                        @if($businessManagement->status == ACTIVE)
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <!--begin::Edit-->
                                            <a href="#" data-item="{{ $businessManagement }}"
                                               data-updateurl="{{ route('admin.trade.business-management.update', $businessManagement->id) }}"
                                            ...
                                            <button class="btn btn-icon btn-danger deleteItem"
                                                    data-formid="delete_row_form_{{$businessManagement->id}}">
                                            ...
                                            <form
                                                action="{{ route('admin.trade.business-management.delete', $businessManagement->id) }}"
                                                method="post" id="delete_row_form_{{ $businessManagement->id }}">
                                                {{ method_field('DELETE') }}
                        ...
                        <!--end::Table-->
                        {{ $businessManagements->links('pagination::bootstrap-4') }}
                    </div>
                    <!--end::Card body-->
                </div>
                <!--end::Card-->
