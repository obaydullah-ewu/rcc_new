    ...
    <div class="aside-toolbar flex-column-auto" id="kt_aside_toolbar">
        ...
        <div class="aside-user d-flex align-items-sm-center justify-content-center py-5">
            ...
            <div class="symbol symbol-50px">
                <img src="{{ getFile(@Auth::user()->image) }}" alt=""/>
            </div>
            <!--end::Symbol-->
            <!--begin::Wrapper-->
                    ...
                    <div class="me-n2">
                        ...
                        <div
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="{{ asset(getFile(@Auth::user()->image)) }}"/>
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                                    <div class="d-flex flex-column">
                                        <div
                                            class="fw-bolder d-flex align-items-center fs-5">{{ auth()->user()->name_bn ?? auth::user()->name_en }}</div>
                                        <a href=""
                            ...
                            <div class="menu-item px-5 ">
                                <a href="{{ route('user.my-profile') }}" class="menu-link px-5">আমার প্রোফাইল</a>
                            </div>
                            <!--end::Menu item-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div
                ...
                <div class="menu-item">
                    <a class="menu-link {{ @$subNavDashboardActiveCLass }}" href="{{ route('user.dashboard') }}">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion d-none {{ @$navTradeLicenseActiveClass }}">
					<span class="menu-link ">
                        ...
                        <span class="menu-title">ই-ট্রেড লাইসেন্স</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item menu-accordion">
                            <a href="{{ route('user.trade-license.index') }}"
                               class="menu-link {{ @$subNavTradeLicenseListActiveClass }}">
                                <span class="menu-bullet">
                                   <i class="fas fa-list-ul"></i>
                                </span>
                                <span class="menu-title">ই-ট্রেড লাইসেন্স তালিকা</span>
                            </a>
                        </div>
                    </div>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item menu-accordion">
                            <a href="{{ route('user.trade-license.create') }}"
                               class="menu-link {{ @$subNavCreateTradeLicenseActiveClass }}">
                                <span class="menu-bullet">
                                   <i class="fas fa-list-ul"></i>
                                </span>
                                <span class="menu-title">ই-ট্রেড লাইসেন্স আবেদন</span>
                            </a>
                        </div>
                    </div>
                </div>
