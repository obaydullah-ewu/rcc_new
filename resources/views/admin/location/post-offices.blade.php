                ...
                <div class="card">
                            ...
                            <form action="" method="get">
                                ...
                                <div class="d-flex align-items-center position-relative mr-2">
                                    <input type="search" class="form-control form-control-solid w-250px "
                                           name="search_string" id="search_string" placeholder="পোস্ট অফিস নাম অনুসন্ধান করুন"
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            @forelse(@$postOffices as $postOffice)
                                <!--begin::Table row-->
                                <tr>
                                    <!--begin::Checkbox-->
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$postOffice->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$postOffice->upazila->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$postOffice->upazila->district->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-gray-800">{{ @$postOffice->upazila->district->division->name }}</span><br>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <!--begin::Edit-->
                                            <a href="#" data-item="{{ $postOffice }}" data-updateurl="{{ route('location.postOffice.update', $postOffice->id) }}"
                                            ...
                                            <!--end::Edit-->
                                            <!--begin::Delete-->
                                            <button class="btn btn-icon btn-danger deleteItem" data-formid="delete_row_form_{{$postOffice->id}}">
                                            ...
                                            <form action="{{ route('location.postOffice.delete', $postOffice->id) }}" method="post" id="delete_row_form_{{ $postOffice->id }}">
                                                {{ method_field('DELETE') }}
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center">কোন রেকর্ড পাওয়া যায়নি</td>
                                </tr>
                            @endforelse
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            <!--begin:Form-->
                            <form id="kt_modal_new_target_form" class="form" action="{{ route('location.postOffice.store') }}" method="post">
                                @csrf
                                <!--begin::Heading-->
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">পোস্ট অফিস যুক্ত করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Input group-->
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" class="form-control form-control-solid" placeholder="পোস্ট অফিস নাম" name="name" required />
                                </div>
                                <!--end::Input group-->
                                <!--begin::Actions-->
                    ...
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_new_target_edit_form" class="form" action="" method="post">
                                ...
                                <div class="mb-13 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3 modalHeaderH1">পোস্ট অফিস আপডেট করুন</h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Input group-->
                                <div class="d-flex flex-column mb-8 fv-row">
                                    <label class="required fs-6 fw-bolder mb-2">বিভাগ নাম</label>
                                    <select class="form-select form-select-solid division_edit" data-hide-search="true" data-placeholder="Select a Division" name="division_id" required>
                                        <option value="">বিভাগ নাম</option>
                                        @foreach($divisions as $division)
                                            <option value="{{ $division->id }}">{{ $division->name }}</option>
                                        @endforeach
